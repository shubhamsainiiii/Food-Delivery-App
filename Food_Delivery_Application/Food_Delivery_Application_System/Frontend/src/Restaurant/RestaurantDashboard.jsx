...
const RestaurantDashboard = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#39244a] via-[#522b53] to-[#5a6a91] p-4 text-white">
                Loading...
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen flex bg-gradient-to-br from-[#39244a] via-[#522b53] to-[#5a6a91]">
            ...
            <main className="flex-1 p-6 overflow-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {/* Recent Orders Table */}
                    <div className="col-span-2 bg-white/10 rounded-2xl shadow-lg p-6 border border-white/20 backdrop-blur-md overflow-auto">
                        <h2 className="text-xl font-semibold text-white mb-4">Recent Orders</h2>
                        <table className="w-full text-left text-white text-sm">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr className="border-t border-white/20">
                                    ...
                                    <td>₹150</td>
                                    <td>
                                        <span className="text-yellow-300">Preparing</span>
                                    </td>
                                </tr>
                                <tr className="border-t border-white/20">
                                    <td className="py-2">#2041</td>
                                    ...
                                    <td>₹360</td>
                                    <td>
                                        <span className="text-blue-300">On the way</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
