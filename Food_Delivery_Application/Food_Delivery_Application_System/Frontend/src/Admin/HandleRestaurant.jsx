                        ...
                        <table className="w-full text-sm text-left text-gray-700">
                            <thead className="bg-gray-100 text-xs uppercase text-gray-500 border-b">
                                <tr>
                                    ...
                                    <th className="py-3 px-4">Status</th>
                                    <th className="py-3 px-4">Actions</th>
                                    <th className="py-3 px-4">Details</th> {/* 👈 New column */}
                                </tr>
                            </thead>
                            <tbody>
                                {filteredRestaurants.map((r, index) => (
                                    <tr key={r._id} className="border-b hover:bg-gray-50 transition-all duration-300">
                                        ...
                                        <td className="py-3 px-4">
                                            <button
                                                onClick={() => window.location.href = `/admin/restaurantdetail?id=${r._id}`}
                                                className="px-3 py-1 rounded-full bg-blue-100 text-blue-600 text-xs font-semibold"
                                            >
                                                View Details
                                            </button>
                                        </td>
